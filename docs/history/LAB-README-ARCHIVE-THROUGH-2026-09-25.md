# Archived Lab README material through 25 September 2026
...
Source: `LAB-README-HISTORY.md`; original SHA-256 `2b26cd8808c94498cf0a9a78747079ee60e6da508426b1598391b2e7e76d4641`; 295,013 bytes; 4,802 lines. The byte-identical
...
<a id="source-lab-readme-history-md-l1"></a>
# Archived QCSD Lab README

> **Frozen and superseded — 10 September 2026 (Australia/Sydney).** This archive
> preserves the former 4,787-line Lab README as historical implementation and
> cohort chronology. Its original body begins below this banner and is unchanged;
> the original file SHA-256 was
> `d6b954570e1d9ab53aacd007419141c760431b50525bd6631801dcdb80ec62ad`.
> Use the [current Lab operator README](../../README.md) for operating
> instructions, and establish current claims from Git and immutable executed
> receipts. Relative links inside the preserved body retain their original
> `neqo-qcsd-lab/` base. Do not update this archive when the live project
> changes.

---

<a id="source-lab-readme-history-md-l16"></a>
# QCSD lab
...
<a id="source-lab-readme-history-md-l39"></a>
## Commands
...
<a id="source-lab-readme-history-md-l46"></a>
...
completion tokens. At this historical checkpoint it had no source-bound live
receipt; v68's successful build and probe are recorded below. V67 authorises no
downstream capture and every extended-campaign scientific numerator remains
zero. The positive worker/OOPIF
...
V68 subsequently bound exact clean Lab
`a0ed21ebe264dd7d4b8ea838ef456071df75564a` and unchanged Rust/gitlink
`ce0d7a21756ce795d6f50d750a1c25e0fa006327`. Its pull/no-cache three-image
build and canonical completion passed; their whole-file SHA-256 values are
`aad756c83f185b54cf915132eb2540268d0717c498a1485cab214345a1bc8c3e`
and `107d95ffb99cf1508c6a92222163c95a38ee547c1d3aa410a0bcd9c054e8fc24`.
The collection, preparation, and isolated-reference image identities are
`sha256:0c8f191176bbecacfbf4fd9acb8aa68606195bc60a43118fdb6824c3ab1c6a11`,
`sha256:ad5ab8c18353d175fb39bb7f8cc7c9d67bb1fc971ba4b04a358cca196b99d8a6`,
and
`sha256:2587463c78b0417f51ae169b2f16999914a46ceafb58e55c87fb54245cf46347`.
Its source-bound pinned-CDP gate also passed, with whole-file SHA-256
`f7dfe27585aa169865d3cf4279b784d15d05c1ba776ab8494d379398ba314568`
and probe-contract SHA-256
`3fa23e65a63a3b5646155538859afa382b48d790ec5ae2f6bc3cdcddbd712059`.

The immediately following browser-egress `create` attempt stopped before a
result root, Docker topology, or vector was created. Its live-Docker projection
had been invoked through Bash command substitution, changing `BASHPID` and
correctly failing the lifecycle guardian's exact supervisor-identity check.
Lab `9c85da3abac680cc787dd65c38ebd72ead026e7d` keeps that projection in the
...
`wasClean=true`. Its focused suites are green and Lab implementation checkpoint
`03b0953235e45dcbd71cfcad63b3342924f9c3b8` commits the repair. Because these
source changes postdate the v69 images and receipts, do not resume v69 for
current-source evidence.

V70 attempted the required fresh build from that Lab checkpoint and Rust
`ce0d7a21756ce795d6f50d750a1c25e0fa006327`. Buildx record
`n44v6f6q9s4so2l0melgh35qn` reached 47/60 collection stages before the embedded
`neqo-bin` gate exposed a timing-flaky test assertion: the authoritative
half-open deadline legitimately expired before the first synthetic incoming
retry drive, while the test incorrectly required at least one drive. Its other
245 tests passed. V70 emitted no build-execution or build-completion receipt and
is consumed. V71 was then consumed before Docker mutation because v70's intact
failed-build transaction correctly blocked lifecycle admission. Their
byte-identical claim/consumed SHA-256 values are, respectively,
`03b3804e2b0c5a5af2e4bf9b4ac8cd4708646ba263d5785da17cbc3b15c665c5`
and `14fe06ff4c943925271110e8c41ca261808662c043ee3bab14f927ce517f819a`.
An exact no-owner/no-object audit preserved v70's transaction and build records at
...
Clean Lab `2bab7a2c0a0d06e82e0f55102a3c1b7e552ef86f` implemented the source
repair that replaces archive-copy extraction with
...
conditional or `|| false` boundaries. It changed source and manifest identity,
so v72 cannot be resumed for current-source evidence. Its acquisition-watcher
suite passes 262 tests, but that is engineering-only evidence.

V73 then completed the canonical fresh pull/no-cache three-image build for
that exact clean Lab source and clean Rust/gitlink
`46313bef90ad392b7ca293ab7cf28108d2f35c7f`. Its
build execution (`artifacts/buflo-study/build-execution-v73.json`) and
completion (`artifacts/buflo-study/build-completion-v73.json`) whole-file
SHA-256 values are
`6ea74774a810af3863803bc7dd4cbc2dccee2c666aac02d7c40daa51ebae2c79`
and `61d04da97d85c1d22d26242f6c51ea542637c16afa28d41216fdff001ccf853b`.
The collection, preparation, and isolated-reference image identities are
`sha256:d39ef6517b1ec2e8d3ac5a0da6906db60340a0eeb01384b5e4f664783bd156c1`,
`sha256:8b040ea09cc46d94a3a5eb680ca54ab0118cc77ddcce978697a82f0f4aec0532`,
and
`sha256:6ae63c6355614a783297a2df29e210a2607d6f7503fc0033ff92c32e3e513e6c`.
Its pinned-CDP receipt (`artifacts/buflo-study/pinned-cdp-execution-v73.json`)
also passed, with whole-file SHA-256
`1491dccf83d64e20649dd80acfcefd29a9683494605d6ca6c022a13ce44069b6`.

Browser-egress vector 1 successfully streamed and sealed a 16,168-byte PCAP as
failure evidence, but the
v73 checkpoint (`artifacts/buflo-study/browser-egress-qualification-v73/experiment.json`)
is terminal `failed`. Attempt 1 for `constructor--page--websocket` ended
`runtime-binding-failed` at `runtime-projection` because the launcher had not
initialised `QCSD_DOCKER_OUTPUT_BROWSER_EGRESS_RUNTIME` before assigning that
...
V75 and v76 were subsequently consumed before a complete build pair. V75's
claim (`artifacts/buflo-study/cohort-claims-v1/claim-v75.json`) has whole-file
SHA-256
`445778ef6f52745771148f98724e449ef3fb75c196138a5eb459e6a10b0dbfb6`.
Its late source-authority reproof failed after concurrent `git status`
refreshed sealed Git-directory metadata, although source and index bytes were
unchanged. V76's
claim (`artifacts/buflo-study/cohort-claims-v1/claim-v76.json`) has whole-file
SHA-256
`5b3a9cf871e7790805e290474c4d8fbd0bfba74a40c864d36944c97c0dbc53e9`.
Its preparation build encountered transient Docker DNS failure after the
collection image and embedded Rust gate passed. Neither cohort emitted a
build-execution, completion, or downstream receipt.

V77 then passed the canonical fresh pull/no-cache
build (`artifacts/buflo-study/build-execution-v77.json`) and
completion (`artifacts/buflo-study/build-completion-v77.json`) pair plus the
pinned-CDP gate (`artifacts/buflo-study/pinned-cdp-execution-v77.json`) for exact
clean Lab `15e478dc7bf8a52740d773de4fad4877140bc4a4` and clean Rust/gitlink
`46313bef90ad392b7ca293ab7cf28108d2f35c7f`. Build/completion whole-file
SHA-256 values are
`f8ee75e2d80389daa80d1fef22b7e5aaa9f23aefd46c6dc4dea3df50d814bbbd` /
`c415cec5fc6f5b587d458074c32c357903745153febdf7eb211007f432466dd1`;
the pinned-CDP whole-file/payload values are
`87b83635c40868736288b55997f25b2905078a43451b3da74a8ae24f9fa1f041` /
`d0b597853809e5dc935046a67901cd3fcfaabc2fa726acd8bbc33946c7990ef9`.

The v77 browser-egress checkpoint (`artifacts/buflo-study/browser-egress-qualification-v77/experiment.json`)
is terminal `failed` with whole-file SHA-256
`fa0b0324197d59d607fc5eedc1657be1fdafa0cfeadc17d2fe8f1d6cb9cd0864`.
Vector 1 sealed one failed attempt but no passed vector or final receipt. The
live Docker 29 topology contained exactly the required browser, fixture,
forbidden-sink, and DNS-sink members; the observer correctly shared the
browser namespace. The launcher projected membership only after shutdown,
when Docker had cleared `.Containers`, endpoint IDs, and addresses. This is a
temporal orchestration defect, not stale Docker state or a defence failure.

This source implements a two-phase schema-3 projection: live topology is bound
before role shutdown, and stopped-container state plus teardown are bound
afterwards. Engineering validation passed all 444 affected tests, including a
real Docker 29 namespace/lifecycle test and the complete synthetic 110-vector
...
pinned-CDP before receipt on the paused-OOPIF default-context deadlock. V68
...
authoritative workspace [`PROJECT.md`](PROJECT-LEDGER-THROUGH-2026-09-18.md).
...
`capture-finalization` extraction failure. V73's valid build/completion and
...
maintained in
[`../PROJECT.md`](PROJECT-LEDGER-THROUGH-2026-09-18.md); the exact extended-class protocol and
matrices are maintained in [`../CLASS-STUDY.md`](CLASS-STUDY-METHODOLOGY-THROUGH-2026-09-18.md).

<a id="source-lab-readme-history-md-l2112"></a>
...
<a id="source-lab-readme-history-md-l2131"></a>
...
[`../CLASS-STUDY.md`](CLASS-STUDY-METHODOLOGY-THROUGH-2026-09-18.md).
...
<a id="source-lab-readme-history-md-l2534"></a>
...
[canonical-layout section](CLASS-STUDY-METHODOLOGY-THROUGH-2026-09-18.md#source-class-study-md-l2218).
...
<a id="source-lab-readme-history-md-l2740"></a>
...
[class-foundation and acquisition bootstrap](CLASS-STUDY-METHODOLOGY-THROUGH-2026-09-18.md#source-class-study-md-l2368):
...
<a id="source-lab-readme-history-md-l3044"></a>
### `build`
...
<a id="source-lab-readme-history-md-l3064"></a>
### `prepare`
...
<a id="source-lab-readme-history-md-l3102"></a>
...
<a id="source-lab-readme-history-md-l3116"></a>
### `qualify-chaff`
...
<a id="source-lab-readme-history-md-l3146"></a>
...
<a id="source-lab-readme-history-md-l3537"></a>
### `run`
...
<a id="source-lab-readme-history-md-l3571"></a>
### `resume`
...
<a id="source-lab-readme-history-md-l3606"></a>
### `verify`
...
<a id="source-lab-readme-history-md-l3633"></a>
### `analyze`
...
<a id="source-lab-readme-history-md-l3654"></a>
...
<a id="source-lab-readme-history-md-l3797"></a>
### `fit`
...
<a id="source-lab-readme-history-md-l3826"></a>
### `test`
...
<a id="source-lab-readme-history-md-l3835"></a>
### `test pinned-cdp`
...
<a id="source-lab-readme-history-md-l3890"></a>
### `test browser-egress`
...
<a id="source-lab-readme-history-md-l3921"></a>
### `test live`
...
<a id="source-lab-readme-history-md-l3937"></a>
## Profiles
...
<a id="source-lab-readme-history-md-l3955"></a>
## Campaigns
...
<a id="source-lab-readme-history-md-l4162"></a>
...
<a id="source-lab-readme-history-md-l4225"></a>
...
<a id="source-lab-readme-history-md-l4254"></a>
## Result contract
...
<a id="source-lab-readme-history-md-l4372"></a>
...
<a id="source-lab-readme-history-md-l4420"></a>
...
<a id="source-lab-readme-history-md-l4523"></a>
