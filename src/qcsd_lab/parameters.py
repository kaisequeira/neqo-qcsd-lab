...
PREVIOUS_TIMING_STRESS_V7_INPUT_POLICY = "controlled-test-only-timing-stress-v7"
PREVIOUS_TIMING_STRESS_V8_INPUT_POLICY = "controlled-test-only-timing-stress-v8"
PREVIOUS_TIMING_STRESS_V9_INPUT_POLICY = "controlled-test-only-timing-stress-v9"
TIMING_STRESS_INPUT_POLICY = "controlled-test-only-timing-stress-v10"
...
def _validate_timing_stress_parameter_artifact(
    ...
    *,
    ...
    v8_parameter_path = timing_root / "buflo-timing-stress-v8.json"
    v9_parameter_path = timing_root / "buflo-timing-stress-v9.json"
    v10_parameter_path = timing_root / "buflo-timing-stress-v10.json"
    if parameter_path == v1_parameter_path:
        ...
        input_policy = PREVIOUS_TIMING_STRESS_V4_INPUT_POLICY
        expected_capture_contract = {
            "schema_version": 4,
            "visits": 12,
            "max_attempts": 1,
    ...
    elif parameter_path == v5_parameter_path:
        provenance_schema_version = 5
        input_policy = PREVIOUS_TIMING_STRESS_V5_INPUT_POLICY
        expected_capture_contract = {
            "schema_version": 5,
            "visits": 12,
            "max_attempts": 1,
        ...
        expected_capture_contract = {
            ...
            "runner_wakeup_schema_version": 13,
            "legacy_userspace_exact_release_projection": (
                "schema-10-compatibility-fields-retained-and-neutral"
            ),
        ...
        input_policy = PREVIOUS_TIMING_STRESS_V7_INPUT_POLICY
        expected_capture_contract = {
            "schema_version": 7,
            "visits": 12,
            "max_attempts": 1,
    ...
    elif parameter_path == v8_parameter_path:
        provenance_schema_version = 8
        input_policy = PREVIOUS_TIMING_STRESS_V8_INPUT_POLICY
        expected_capture_contract = {
            "schema_version": 8,
            "visits": 12,
            "max_attempts": 1,
    ...
    elif parameter_path == v9_parameter_path:
        provenance_schema_version = 9
        input_policy = PREVIOUS_TIMING_STRESS_V9_INPUT_POLICY
        expected_capture_contract = {
            "schema_version": 9,
            "visits": 12,
            "max_attempts": 1,
    ...
    elif parameter_path == v10_parameter_path:
